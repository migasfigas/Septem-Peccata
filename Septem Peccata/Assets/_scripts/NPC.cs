...
public class NPC {
    ...
    private ArrayList oldmanDialog = new ArrayList(2);
    private string[] suggestionDialog = { "hello there", "friend", "i dont know what to say", "no one gave me a script", "i'm just a lonely capsule in the middle of nowhere", "go find me some friends please?" };
	...
	public void Update () {
        ...
        //só é lido o input se o jogador se encontrar na área de colisão maior do NPC ou quando a caixa de dialogo está ativa
    ...
    {
        //se o jogador decidir interagir com o NPC é alterado um booleano na main que indica que o jogador está a falar, ou seja, não se pode movimentar etc e é ligada a caixa de dialogo
        ...
        /*Se a caixa de diálogo estiver ativa (o jogador está a falar) é lido o input da tecla enter que é usado para prosseguir as mensagens do NPC. Dependendo se tem um quest ativo
    ...
    private void setText(int click, string[] text)
    {
        ...
        /*se o jogador ainda não tiver aceite um quest são apresentados os botões para aceitar/cancelar na penultima mensagem do NPC. Caso contrário quando 
    ...
    //ao colidir com a maior área de colisão do NPC é apresentada a mensagem para interação, quano o jogador sai da area a mensagem desaparece
